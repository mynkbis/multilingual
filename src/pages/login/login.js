...
signInWithPopup(auth, provider)
  .then((result) => {
    ...
    //        console.log("user data",getCurrentPosition);
    //      });
...
// const surya="रिएक्ट और रिएक्ट करने के लिए आपका स्वागत है-i18next"



return(
    <>
        {/* <h1>{t('Welcome_to_React',{surya:10}) }</h1> */}
        ...
        <div className="right-side">
                ...
                <div className="register">
                            <span style={{ fontSize: ".8rem" }}><Trans i18nKey="Login.5">Don't have an account?</Trans>
                                <Link to="../signup"><strong> <Trans i18nKey="Login.6">Register</Trans></strong></Link></span>
