...
const Tick=()=>{
    ...
    const submitForm = async (e) => {
        ...
        try {
      const user = await createUserWithEmailAndPassword(auth, inputText.email, inputText.password).then(cred => {
     ...
     <div className="form">
        ...
        <div className="right-side">
                ...
                <div className="input-text">
                    <input type="text" placeholder="Email" className={`${wemail ? "text-warning" : ""}`} value={inputText.email} onChange={inputEvent} name="email"  />
                    
                    <i className="fa fa-envelope"></i>
                </div>
                <div className="input-text">
                    <input type={inpass} placeholder="Password" className={` ${warning ? "warning" : ""} ${wpassword ? "text-warning" : ""}`} value={inputText.password} onChange={inputEvent} name="password"  />
...
{/*                
                <div className="rem_pass">
                    <div className="remember">
                         ...
                         <p>Remember Me</p>
                            ...
                            <p style={{fontSize:".8rem"}}>Don't have account? <a href="#"><strong>Register</strong></a></p>
                ...
                <div className="button">
                    ...
                    <p> <Trans i18nKey="SignUP.3">or</Trans></p> 
                         ...
                         <Link to="../login"> <strong><Trans i18nKey="ForgetPass.4">  Click Here!</Trans></strong></Link>  </p>
                                </div>
